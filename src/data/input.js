...
export const ACTIONS = Object.freeze({
  ...
  dodge: { label: 'Kaçın (yuvarlan) / süpürgede takla', rebindable: true },
  broom: { label: 'Süpürgeye bin / in', rebindable: true },
  friends: { label: 'Dostlar listesi', rebindable: true },
  journal: { label: 'Günlük (görevler, bina kupası)', rebindable: true },
  map: { label: 'Harita', rebindable: true },
