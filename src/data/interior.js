  ...
  cells: [
    {
      ...
      features: [
        ...
        { type: 'torches', list: [['e', 9.8], ['e', -3], ['w', 1], ['w', 9.5], ['s', -4], ['s', 4]] },
        { type: 'armor', list: [{ pos: [12.9, -7.5], face: 'w' }, { pos: [-12.9, 12.6], face: 'e' }, { pos: [12.9, 12.6], face: 'w' }] },
        { type: 'chandelier', pos: [0, 10.5, 2], radius: 2.2, candles: 16, light: { color: 0xffc27a, intensity: 18, distance: 26 } },
        { type: 'portraits', list: [...row('w', -8, -3, 2.5, 3, [1, 1.3]), ...row('e', 5, 11, 3, 3, [1, 1.3])] },
      ],
    },
    {
      id: 'greatHall',
